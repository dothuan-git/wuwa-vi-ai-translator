...
DEFAULT_CONFIG = {
    ...
    "system_prompt": (
        ...
        "PRONOUNS:\n"
        "Each turn includes explicit pronoun tags — use them literally, do NOT infer or substitute:\n"
        ...
        "When tags are absent (narration / system text), stay neutral and drop pronouns where natural.\n\n"
        "TRANSLATION RULES:\n"
